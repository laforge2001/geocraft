...
public class SeismicDatasetRendererDialog extends PreferencesModelDialog implements ISeismicDatasetRendererConstants,
    ColorMapListener {

  /** The associated trace renderer. */
  protected final SeismicDatasetRenderer _renderer;
  ...
  public SeismicDatasetRendererDialog(final Shell shell, final String title, final SeismicDatasetRenderer renderer) {
    super(shell, title);
    _renderer = renderer;
  }
  ...
  protected void buildModelForms(final IModelForm[] forms) {
    ...
    _overlayColorBarEditor = new ColorBarEditor(container, ((SeismicDatasetRendererModel) _model).getColorBar(), 384);
  ...
  public void propertyChanged(final String key) {
    SeismicDatasetRendererModel model = (SeismicDatasetRendererModel) _model;
  ...
  protected IModel createModel() {
    SeismicDatasetRendererModel model = new SeismicDatasetRendererModel(_renderer.getSettingsModel());
