...
public class FaultRendererPreferencePage extends FieldEditorOverlayPage implements IWorkbenchPreferencePage,
  ...
  public static final String ID = "org.geocraft.ui.sectionviewer.fault";
  ...
  public void init(final IWorkbench workbench) {
    setDescription("Preferences for fault plotting in the section viewer.");
  }
  ...
  protected void createFieldEditors() {
    ...
    BooleanFieldEditor faultPicksVisibleField = new BooleanFieldEditor(SEGMENTS_VISIBLE, "Show Pick Segements",
        faultPicksGroup);
    ...
    IntegerFieldEditor distanceToleranceField = new IntegerFieldEditor(DISTANCE_TOLERANCE, DISTANCE_TOLERANCE,
        faultPicksGroup);
