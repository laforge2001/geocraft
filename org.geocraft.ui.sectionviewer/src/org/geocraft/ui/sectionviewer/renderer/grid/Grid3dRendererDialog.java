 ...
 */
public class Grid3dRendererDialog extends PreferencesModelDialog implements IGridRendererConstants {

  /** The grid renderer. */
  private final Grid3dRenderer _renderer;

  public Grid3dRendererDialog(final Shell shell, final String title, final Grid3dRenderer renderer) {
    super(shell, title);
    _renderer = renderer;
  }
