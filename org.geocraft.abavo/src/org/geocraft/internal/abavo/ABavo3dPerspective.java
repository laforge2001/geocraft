...
import org.geocraft.abavo.crossplot.CrossplotAvsB3d;
import org.geocraft.algorithm.StandaloneAlgorithmRegistry;


public class ABavo3dPerspective implements IPerspectiveFactory {
  ...
  public void createInitialLayout(final IPageLayout layout) {
    ...
    try {
      IEditorPart part = PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().openEditor(
          StandaloneAlgorithmRegistry.getInstance().getEditorInput(CrossplotAvsB3d.class.getName()),
