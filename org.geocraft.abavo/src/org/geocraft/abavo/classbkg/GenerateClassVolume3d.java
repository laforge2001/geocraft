...
public class GenerateClassVolume3d extends ABavoBaseAlgorithm3d implements IGenerateClassVolumeConstants {
  ...
  public void initialize(IRepository repository) {
    ...
    try {
      ...
      _outputProcess = new OutputPostStack3dProcess("Output Class Volume", outputVolume);
      _outputProcess.initialize();
  ...
  protected ABavoAlgorithm3dWorker createWorker(final int workerID, final IProgressMonitor monitor,
    ...
    ClassificationProcess classificationProcess = new ClassificationProcess(_classificationProcess);
    GenerateClassVolume3dWorker worker = new GenerateClassVolume3dWorker(workerID, monitor, logger, repository,
        inputProcess, classificationProcess, _outputProcess);
    return worker;
  }
}
