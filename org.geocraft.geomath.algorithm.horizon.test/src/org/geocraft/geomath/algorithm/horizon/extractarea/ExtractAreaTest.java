 ...
 */
package org.geocraft.geomath.algorithm.horizon.extractarea;
...
public class ExtractAreaTest extends TestCase {
  ...
  /**
   * Tests extracting an area.
   */
  public void testExtractArea() {

    // Run the extract area.
    ExtractArea extractArea = new ExtractArea();
    float[][] results = extractArea.extractGridData(_grid, _areaOfInterest, new NullProgressMonitor());

    // Check the results.
    float[][] expected = new float[][] { { NULL_VALUE, NULL_VALUE, NULL_VALUE, NULL_VALUE, NULL_VALUE },
        { NULL_VALUE, 12, 14, NULL_VALUE, NULL_VALUE }, { NULL_VALUE, 22, 24, NULL_VALUE, NULL_VALUE },
