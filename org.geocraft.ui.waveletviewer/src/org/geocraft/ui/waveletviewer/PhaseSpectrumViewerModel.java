/*
 * Copyright (C) ConocoPhillips 20010 All Rights Reserved.
 */
...
/**
 * The model of phase spectrum viewer display properties.
 * @author hansegj
 *
 */
public class PhaseSpectrumViewerModel extends Model implements IModelSpaceListener {
  ...
  public PhaseSpectrumViewerModel(final IModelSpace mspace) {
