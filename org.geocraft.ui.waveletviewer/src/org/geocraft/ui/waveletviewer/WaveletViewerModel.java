...
/**
 * The model of wavelet viewer display properties.
 * @author hansegj
 *
 */
public class WaveletViewerModel extends Model implements IModelSpaceListener {
  ...
  public WaveletViewerModel(final IModelSpace mspace) {
