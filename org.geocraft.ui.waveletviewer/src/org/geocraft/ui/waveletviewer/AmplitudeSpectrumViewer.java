...
import org.geocraft.ui.waveletviewer.renderer.AmplitudeSpectrumRenderer;
import org.geocraft.ui.waveletviewer.renderer.WaveletViewRenderer;


public class AmplitudeSpectrumViewer extends AbstractDataViewer implements IWaveletViewer, ICursorListener {

  /** The logger. */
  private static ILogger LOGGER = ServiceProvider.getLoggingService().getLogger(AmplitudeSpectrumViewer.class);

  /** The amplitude spectrum viewer's model of display properties */
  private AmplitudeSpectrumViewerModel _model;
  ...
  public AmplitudeSpectrumViewer(final Composite parent, final String title) {
    super(parent, true, true, false, false);
    _model = new AmplitudeSpectrumViewerModel(_plot.getActiveModelSpace());
  ...
  @Override
  protected void initializeLayeredModel(ILayeredModel model, Map<String, IViewLayer> folderLayers) {
            ...
            public void run() {
              ...
              for (IConfigurationElement config : configsMulti) {
                ...
                try {
                  ...
                  rendererMulti.setData(shell, AmplitudeSpectrumViewer.this, objects);
                } catch (Exception ex) {
              ...
              for (Object obj : objects) {
                ...
                for (IConfigurationElement config : configsSingle) {
                  ...
                  try {
                    ...
                    if (!rendererExists) {
                      newRenderer.setData(shell, AmplitudeSpectrumViewer.this, new Object[] { object });
                    }
                  } catch (Exception ex) {
  ...
  private void setBounds() {
    ...
    modelSpace.setViewableBounds(0, maxFrequency, bounds.getStartY(), bounds.getEndY());
    modelSpace.setDefaultBounds(0, maxFrequency, bounds.getStartY(), bounds.getEndY());
  }

  private static IModelSpace initializeModelSpace() {
    String modelSpaceName = "Amplitude vs Frequency";
    ...
    IAxis yAxis = new Axis(yAxisLabel, Unit.SEISMIC_AMPLITUDE, new AxisRange(-180, 180), Orientation.VERTICAL);
  ...
  public void addRenderer(String klass, Map<String, String> props, String uniqueId) {
    ...
    renderer.setData(shell, AmplitudeSpectrumViewer.this, objects, false);
    //set the renderer's model properties
    Model model = renderer.getSettingsModel();
    //Note: renderer has no model
    if (model != null) {
  ...
  protected List<IConfigurationElement> findRenderer(Shell shell, Object object) {
    return RendererRegistry.findRenderer(shell, object, AMPLITUDE_SPECTRUM_SUBPLOT);
  }

  @Override
  protected void setRendererData(IRenderer renderer, Shell shell, Object[] objects, boolean autoUpdate) {
    ((AmplitudeSpectrumRenderer) renderer).setData(shell, this, objects, autoUpdate);
  }
