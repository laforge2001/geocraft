...
/**
 * The model of map viewer display properties.
 */
public class MapViewerModel extends Model implements IModelSpaceListener {
  ...
  public MapViewerModel(final IModelSpace mspace) {
