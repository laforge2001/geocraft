...
public class PreStack3dRenderer extends MapViewRenderer {

  /** The 3D poststack dataset to render. */
  private PreStack3d _poststack;

  /** The model of display settings. */
  private final PreStack3dRendererModel _model;

  public PreStack3dRenderer() {
    super("PostStack 3d Renderer");
    _model = new PreStack3dRendererModel();
  ...
  protected void addPopupMenuActions() {
    //Dialog dialog = new PreStack3dRendererDialog(_shell, _poststack.getDisplayName(), this);
  ...
  protected void setRenderedObjects(final Object[] objects) {
    _poststack = (PreStack3d) objects[0];
  }

  public PreStack3dRendererModel getSettingsModel() {
    return _model;
  }
   ...
   */
  public void updateSettings(final PreStack3dRendererModel model, final ColorBar colorBar) {
