...
public class PreStack3dRendererModel extends Model {
   ...
   */
  public PreStack3dRendererModel() {
    super();
   ...
   * @param model the poststack 3d renderer model to copy.
   */
  public PreStack3dRendererModel(final PreStack3dRendererModel model) {
    this();
    updateFrom(model);
