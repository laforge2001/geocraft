...
public class DeselectPointAction extends AbstractPlotMouseAction {

  public DeselectPointAction(final PlotActionMask mask) {
    super(mask, "Deselect Point", "Deselects the selected point.");
  }
