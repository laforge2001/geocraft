...
public class SelectPointAction extends AbstractPlotMouseAction {

  public SelectPointAction(final PlotActionMask mask) {
    super(mask, "Select Point", "Selects the nearest point (within a tolerance).");
  }
