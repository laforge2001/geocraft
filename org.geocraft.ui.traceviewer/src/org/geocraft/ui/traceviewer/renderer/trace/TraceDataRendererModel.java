...
public class TraceDataRendererModel extends Model implements ISeismicDatasetRendererConstants {
   ...
   */
  public TraceDataRendererModel(final TraceDataRendererModel model) {
    this();
    setDataUnit(model.getDataUnit());
    updateFrom(model);
  }

  public void updateFrom(final TraceDataRendererModel model) {
