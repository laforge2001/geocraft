...
public class GradientFloodStrategy extends AbstractFloodStrategy {
  ...
  public GradientFloodStrategy(final FloodDirection floodDir, final float velocity, final float gradient, final float referenceDepth) {
    _floodDir = floodDir;
    _velocity = velocity;
    _gradient = gradient;
