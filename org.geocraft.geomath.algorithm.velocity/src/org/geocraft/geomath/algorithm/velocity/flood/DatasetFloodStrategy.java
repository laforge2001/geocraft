...
public class DatasetFloodStrategy extends AbstractFloodStrategy {
  ...
  public DatasetFloodStrategy(final PostStack3d replaceVolume, final FloodDirection floodDir, final float multiplier, final float adder) {
