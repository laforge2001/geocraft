 ...
 */
package org.geocraft.geomath.algorithm.calculator.booleanalgebra;
...
public class BooleanAlgebra extends StandaloneAlgorithm {
  ...
  public BooleanAlgebra() {
    ...
    _operationType = addEnumProperty("The operation to perform", OperationType.class, OperationType.EQ);
