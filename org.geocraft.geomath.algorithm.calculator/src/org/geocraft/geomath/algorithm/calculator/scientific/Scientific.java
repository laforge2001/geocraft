 ...
 */
package org.geocraft.geomath.algorithm.calculator.scientific;
...
public class Scientific extends StandaloneAlgorithm {

  /** Enumeration for the difference operations */
  public enum OperationType {
    ATAN2("atan2(b,c)", "atan2", ","),
    COS("cos(b)", "cos", ""),
    SIN("sin(b)", "sin", ""),
    LOG10("log10(b)", "log10", ""),
    LOGN("logn(b)", "logn", ""),
  ...
  public Scientific() {
    ...
    _operationType = addEnumProperty("The operation to perform", OperationType.class, OperationType.ATAN2);
    _operationTypeLabel = addStringProperty("Example", "a = atan2(b,c)");
